...
public class Integrador {
    public static void main(String[] args) throws Exception {
        ...
        final String username = System.getenv("FIF_QA_SERVICE_USER_JIRA");
        final String token = System.getenv("FIF_QA_SERVICE_TOKEN_JIRA");
        ...
        /**
         *
         * Desde aca se comunica con integrador para realizar todas las llamadas, a los servicios
         * También se crea carpeta en jira
         *
         **/
